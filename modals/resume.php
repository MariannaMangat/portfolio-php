  <!-- Resume Modal -->
  <div id="resumeModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="resumeTitle">
    <div class="modal-dialog wide" role="document">
      <div class="modal-content text-left">
        <div class="modal-header">
          <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 id="resumeTitle" class="modal-title text-center">Resume</h3>
        </div><!-- /.modal-header -->
        <div class="modal-body">
          ...
          <div class="row text-center">
            <a class="btn td-btn outline green mb-30" href="assets/docs/tiffany_du_resume.pdf" target="_blank" download><span class="glyphicon glyphicon-download-alt"></span> Download PDF</a>
          ...
          <div class="modal-footer center">
            <button class="btn td-btn outline small" type="button" data-dismiss="modal">Close Resume</button>
          </div><!-- /.modal-footer -->
        </div><!-- /.modal-body -->
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
