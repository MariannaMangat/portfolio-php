  <!-- BechtelMGFX Project Modal -->
  <div id="bechtelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="bechtelTitle">
    <div class="modal-dialog wide" role="document">
      <div class="modal-content text-left">
        <div class="modal-header text-center">
          <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h2 id="bechtelTitle" class="modal-title">BechtelMGFX.com</h2>
          ...
          <div class="flex-container">
            ...
            <div class="flex-item full mb-30">
              <div class="text text-center">
                ...
                <p class="mb-30">
                  <span class="label tag">Wordpress</span>
                ...
                <a class="btn td-btn outline green mb-15" href="https://www.bechtelmgfx.com/" target="_blank" title="Go to BechtelMGFX.com"><span class="glyphicon glyphicon-link"></span> Visit Live Site</a>
              </div>
            </div>
          </div><!-- /.flex-container -->
