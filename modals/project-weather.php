  ...
  <div id="weatherModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="weatherTitle">
    <div class="modal-dialog wide" role="document">
      <div class="modal-content text-left">
        <div class="modal-header text-center">
          <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h2 id="weatherTitle" class="modal-title">Local Weather App</h2>
            ...
            <div class="flex-item full mb-30">
              <div class="text text-center">
                ...
                <p class="mb-30">
                  ...
                  <span class="label tag">Geolocation</span>
                  <span class="label tag">Wunderground API</span>
                </p>
                <a class="btn td-btn outline green mb-15" href="https://tiffanyadu.github.io/weather-app/" target="_blank" title="Go to Local Weather App page"><span class="glyphicon glyphicon-link"></span> Visit Live Site</a>
